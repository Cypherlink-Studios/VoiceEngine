...
- **THEN** it SHALL automatically load the VoiceEngine overview dashboard displaying real-time KPI stat cards, Event Loop Lag percentiles, Mediasoup worker CPU usage gauges, and spatial audio calculation latencies.
